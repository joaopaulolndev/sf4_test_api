...
// Returns the private 'App\Repository\FilmeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FilmeRepository.php';

return $this->privates['App\Repository\FilmeRepository'] = new \App\Repository\FilmeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
