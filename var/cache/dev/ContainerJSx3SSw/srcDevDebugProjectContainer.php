...
class srcDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('movie.search_filter' => function () {
            return ($this->privates['movie.search_filter'] ?? $this->load('getMovie_SearchFilterService.php'));
        }));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'api_platform.eager_loading.enabled' => false,
            ...
            'api_platform.collection.pagination.page_parameter_name' => 'pagina',
            'api_platform.collection.pagination.enabled_parameter_name' => 'pagination',
            'api_platform.collection.pagination.items_per_page_parameter_name' => 'itensPorPagina',
